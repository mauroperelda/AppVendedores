...
map_modules:
	...
	.byte	0xad, 0x6b, 0xb2, 0x90, 0xdd, 0x70, 0x8c, 0x4b, 0xb2, 0xf7, 0xaa, 0x40, 0x1f, 0x37, 0x82, 0xc	// module_uuid: 90b26bad-70dd-4b8c-b2f7-aa401f37820c
	.word	0x1	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module16_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.16	// assembly_name: AppVendedores.Android
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xcb, 0x98, 0xba, 0x8d, 0xe, 0x7b, 0x63, 0x40, 0x95, 0x78, 0x3b, 0x80, 0xb1, 0xbf, 0x37, 0x22	// module_uuid: 8dba98cb-7b0e-4063-9578-3b80b1bf3722
	.word	0x1	// entry_count
	.word	0x0	// duplicate_count
...
map_java:
	...
	.ascii	"crc64561df791271e0ef7/MainActivity"	// java_name
	.zero	67	// byteCount == 34; fixedWidth == 101; returned size == 101
	.zero	3
